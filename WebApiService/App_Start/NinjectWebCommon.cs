...
namespace WebApiService.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            //    kernel.Bind<LogInterceptor>().To<LogInterceptor>();
            //    kernel.Bind<ServiceController>().To<ServiceController>().Intercept().With<LogInterceptor>();
            kernel.Bind<IUserService<UserExtended>>().To<UserService>();
